...
class BasicLayer(nn.Module):
    ...
    def forward(self, x, H, W):
        ...
        return x, H, W, x_origin, H_origin, W_origin
...
class SwinTransformer(nn.Module):
    ...
    def forward(self, x):
        ...
        for layer in self.layers:
            x, H, W, x_origin, H_origin, W_origin = layer(x, H, W)
            batch_size, *_ = x_origin.shape
            output = x_origin.permute(0, 2, 1).reshape(batch_size, -1, H_origin, W_origin)
